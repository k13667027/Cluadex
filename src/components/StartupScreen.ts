 ...
 *   CLUADEX_THEME=dark      — default dark mode
 *   CLUADEX_THEME=sunset    — warm orange-to-rust
 *   CLUADEX_THEME=light     — light mode
 *   CLUADEX_THEME=ocean     — deep teal to cyan
 *   CLUADEX_THEME=aurora    — green to violet northern lights
 *   CLUADEX_THEME=neon      — hot pink to electric blue
 *   CLUADEX_THEME=mono      — clean white-to-grey monochrome
 *   CLUADEX_THEME=matrix    — green terminal hacker style
 */
