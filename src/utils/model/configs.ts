...
// ---------------------------------------------------------------------------
// NVIDIA AI model mappings
// Maps Claude model tiers to NVIDIA NIM equivalents.
// Override with NVIDIA_MODEL env var.
// ---------------------------------------------------------------------------
export const NVIDIA_MODEL_DEFAULTS = {
  opus: 'moonshotai/kimi-k2-instruct',     // best reasoning
  sonnet: 'meta/llama-3.3-70b-instruct',   // balanced
  haiku: 'meta/llama-3.1-8b-instruct',     // fast & cheap
} as const
